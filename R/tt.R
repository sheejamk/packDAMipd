# #######################################################################
# library(packDAMipd)
patient_m <- packDAMipd::load_trial_data(file = "data-raw/patient_m1.txt")
riskscore <- packDAMipd::load_trial_data(file = "data-raw/riskscore.txt")
qol_long <- packDAMipd::load_trial_data(file = "data-raw/r3form2.dta")

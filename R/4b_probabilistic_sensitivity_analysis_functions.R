...
#' @param result_psa_params_control  result from probabilistic sensitivity analysis
#' for first or control model
#' @param result_psa_params_treat result from probabilistic sensitivity analysis

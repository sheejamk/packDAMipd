...
test_that("testing adding EQ5D5L values to the data",  {
  trial_data <- data.frame("qol.MO" = c(1,2), "qol.SC" = c(1,5), "qol.UA" = c(1,2),
  ...
  trial_data <- data.frame("qol.MO" = c(1,2), "qol.SC" = c(1,8), "qol.UA" = c(1,2),
                           "qol.PD" = c(1,2), "qol.AD" = c(1,2))
...
test_that("testing adding EQ5D5L values to the data",  {
  trial_data <- data.frame("qol.MO" = c(1,2), "qol.SC" = c(1,2), "qol.UA" = c(1,2),
                           "qol.PD" = c(1,2), "qol.AD" = c(1,2))
...
test_that("testing adding EQ5D5L values to the data",  {
  trial_data <- data.frame("tpi.q1" = c(1,2), "tpi.q2" = c(1,2), "tpi.q3" = c(1,2),
                           "tpi.q4" = c(1,2),

...
test_that("testing reading parameter from mortality file", {
  ...
  expect_error(get_mortality_from_file(nofile,16))
  # null file error
  expect_error(get_mortality_from_file(NULL, 16))

  # age column doesn't exist error
  expect_error(get_mortality_from_file(diff_file, 16))
  # missing age
  expect_error(get_mortality_from_file(paramfile_missingage, 12))
  # missing mortality column name
  expect_error(get_mortality_from_file(paramfile, 12))

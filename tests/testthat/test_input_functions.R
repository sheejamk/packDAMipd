...
test_that("testing loading trial data",  {
  ...
  expect_equal(load_trial_data(),data)
...
test_that("testing getting the age details",  {
  ...
  expect_error(get_age_details(data.table("no" = c(21, 15), "control" = c("control", "intervention"))))
})
###############################################################################
...
test_that("testing getting the timepoint details",  {
  ...
  expect_equal(details$codes,  c(21, 15))
  details <- get_timepoint_details(data.table("point" = c(21, 15), "control" = c("control", "intervention")))
...
###############################################################################
context("testing check trreatment arm")
test_that("testing check trreatment arm",  {

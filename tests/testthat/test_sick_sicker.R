...
trt_markov <- markov_model(trt_strategy, 85, c(1, 0,0,0),c(0,0,0,0),c(0,0,0,0),discount = c(0.03,0.03),a)
...
plot_ceac(list_markov,threshold_values = c(1000,2000,5000,7000,10000,150000,20000), comparator = "Usual care" , currency ="GBP")

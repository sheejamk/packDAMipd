...
test_that("testing calculating icer nmb", {
  ...
  this_markov <- markov_model(this_strategy, 24, c(1000, 0, 0), discount = c(0, 0))
  well <- health_state("well", cost = 0, utility = 1)
  ...
  sec_markov <- markov_model(this_strategy, 24, c(1000, 0, 0), discount = c(0, 0))
  ...
  sec_markov <- markov_model(this_strategy, 12, c(1000, 0, 0), discount = c(0, 0))
  list_markov <- combine_markov(this_markov, sec_markov)
...
test_that("testing checking list of markov models", {
  ...
  this_strategy <- strategy(tm, health_states, "intervention")
  sec_markov <- markov_model(this_strategy, 24, c(500, 0, 0), discount = c(0, 0))
  list_markov <- combine_markov(this_markov, sec_markov)
  expect_error(check_list_markov_models(list_markov))
  ...
  this_strategy <- strategy(tm, health_states, "intervention")
  sec_markov <- markov_model(this_strategy, 24, c(1000, 0, 0, 0), discount = c(0, 0))
  list_markov <- combine_markov(this_markov, sec_markov)
  expect_error(check_list_markov_models(list_markov))

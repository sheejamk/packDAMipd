...
test_that("testing microcosting patches",  {
  ...
  res = microcosting_patches(example1,"Name", "patch_strength", "patch_dose_unit","patch_no_taken",
  ...
  res = microcosting_patches(example2,"Name", "patch_strength", "patch_dose_unit","patch_no_taken",
                             "patch_frequency",  "day", med_costs, "UnitCost", "StrengthUnit","Strength",
                             list(c("4 weeks", "1 week"), c(1,2)), list(c("Buprenorphine", "Morphine"), c(1,2)),
                             NULL, NULL, "patch_equiv_dose")
  ...
  expect_error(microcosting_patches(ind_part_data,"Name", "strength", "patch_dose_unit","patch_no_taken",
                           "patch_frequency",  "day", med_costs, "UnitCost", "StrengthUnit","Strength",
                           list(c("4 weeks", "1 week"), c(1,2)), list(c("Buprenorphine", "Morphine"), c(1,2)),
  ...
  expect_error(microcosting_patches(ind_part_data,"Name", "patch_strength", "patch_dose_unit","patch_no_taken",
                           "patch_frequency",  "day", med_costs, "UnitCost", "StrengthUnit","Strength",
                           list(c("4 weeks", "1 week"), c(1,2)), list(c("Buprenorphine", "Morphine"), c(1,2)),
                           list(c("Once a day", "twice a day", "once weekly"), c(1,2,3)),
  ...
  expect_error(microcosting_patches(example2,"Name", "patch_strength", "patch_dose_unit","patch_no_taken",
                       "patch_frequency",  "day", med_costs, "UnitCost", "StrengthUnit","Strength",
                       list(c("4 weeks", "1 week"), c(1,2)), list(c("Buprenorphine", "Morphine"), c(1,2)),
...
test_that("testing microcosting tablets",  {
  ...
  res = microcosting_tablets(example1, "Drug", "tab_dosage", "tab_dosage_unit","tab_no_taken",
  ...
  expect_error(microcosting_tablets(example1, "Drug", "tab_dosage", "tab_dosage_unit","tab_no_taken",
                             "tab_frequency", "day", med_costs, "UnitCost",
                             "StrengthUnit",  "Strength",list(c("4 weeks", "1 week"), c(1,2)),
                             NULL, NULL,
                             list(c("mcg","mg", "gm"), c(1,2,3)), "tab_equiv_dose"))

  expect_error(microcosting_tablets(example1, "Drug", "tab_dosage", NULL,"tab_no_taken",
                                    "tab_frequency", "day", med_costs, "UnitCost",
                                    "StrengthUnit",  "Strength",list(c("4 weeks", "1 week"), c(1,2)),
                                    NULL, this_list,
                                    list(c("mcg","mg", "gm"), c(1,2,3)), "tab_equiv_dose"))

  expect_error(microcosting_tablets(example1, "Drug", "tab_dosage", "tab_dosage_unit",NULL,
                                    "tab_frequency", "day", med_costs, "UnitCost",
                                    "StrengthUnit",  "Strength",list(c("4 weeks", "1 week"), c(1,2)),
                                    NULL, this_list,
                                    list(c("mcg","mg", "gm"), c(1,2,3)), "tab_equiv_dose"))
...
test_that("testing microcosting liquids",  {
  ...
  res = microcosting_liquids(example1, "Drug", "liq_dosage", "liquid_dose_unit",
...
test_that("testing costing resource use", {
  ...
  res = costing_resource_use(ind_part_data[2,],
                             "hospital_admission_1",
                             list("length_1","length_2") ,
                             list("nhs_1","nhs_2"),
                             "day",
  ...
  expect_error(costing_resource_use(ind_part_data[2,],
                                    "hospital_admission_1",
                                    list("length_1","length_2") ,
                                    list("nhs_1"),
                                    "day",
  ...
  expect_error(costing_resource_use(ind_part_data[1,],
                                    "daycare",
                                    list("number"),
                                    list("visit"),
                                    "visit",

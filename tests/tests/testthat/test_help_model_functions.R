...
test_that("testing check the inputs for markov model and get the correct method", {
  ...
  changedmethod = checks_markov_pick_method(this.strategy, c(1, 0), c(0, 0),
  ...
  expect_error(checks_markov_pick_method(this.strategy, c(1, 0), c(0, 0),
                                         "cycle", TRUE,NULL,NULL))
  ## size of discount vector should be 2
  expect_error(checks_markov_pick_method(this.strategy, c(1, 0), c(0, 0,0),
                                         "life table", FALSE,NULL,NULL))
  ...
  expect_error(checks_markov_pick_method(this.strategy, c(1), c(0, 0),
                                         "life table", FALSE,NULL,NULL))

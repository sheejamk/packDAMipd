...
This document demonstrates developing For a simple markov model explained in reference \ref[alarid2020cohort] using packDAMipd. This model is explained in STM_01.R file in Cohort-modeling-tutorial provided in DARTH-git github page. 

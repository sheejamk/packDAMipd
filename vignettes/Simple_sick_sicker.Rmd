...
This document demonstrates developing For a simple markov model explained in reference \ref[alarid2020cohort] using packDAMipd. The code using the package "dampack" is shown https://github.com/DARTH-git/Cohort-modeling-tutorial/blob/master/R/STM_01.R 
...
The cost of usual care obtained from https://github.com/DARTH-git/Cohort-modeling-tutorial/blob/master/R/STM_01.R is 156,703 USD while that of the new treatment is  287,912 USD.

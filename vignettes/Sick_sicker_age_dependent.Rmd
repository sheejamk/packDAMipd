...
This document demonstrates development of a  Markov model explained in reference \ref[alarid2020cohort] using this package "packDAMipd". The code using the package "dampack" is shown in https://github.com/DARTH-git/Cohort-modeling-tutorial/blob/master/R/STM_02.R. Here we look at how the model is defined when the transition probabilities (or parameters) are dependent on the model cycle or time. (Another example for considering the time dependency is explained in vignettes/cycle_dependent.html)
...
The cost of usual care obtained from https://github.com/DARTH-git/Cohort-modeling-tutorial/blob/master/R/STM_02.R is  115,415 USD while that of the new treatment is 212,867 USD.
The  QALYs for the usual care and the new treatment are 19.460 and 20.157 respectively.
The ICER obtained is 139,794   

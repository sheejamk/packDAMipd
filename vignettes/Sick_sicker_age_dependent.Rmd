...
This document demonstrates development of a  Markov model explained in reference \ref[alarid2020cohort] using this package "packDAMipd". This model is explained in STM_02.R file in Cohort-modeling-tutorial provided in DARTH-git github page.

...
```
If we generate the parameter table and deterministic sensitivityanalysis for markov model for combination treatment, we can use to generate the report and plot for both ICER and NMB.

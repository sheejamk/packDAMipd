...
uc_markov <- markov_model( uc_strategy, 85, c(1, 0,0,0), c(0.03,0.03),param_list, method = "half cycle correction", TRUE)
...
icerandnamb = calculate_icer_nmb(list_markov, threshold = 20000, comparator = "Usual care")
